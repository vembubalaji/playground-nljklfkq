...
@[Luke, how many stars are there in these galaxies?]({"stubs": ["src/main/java/com/tu/nativesqlsample/NativeQueryNativeJoin.java"], "command": "com.tu.nativesqlsample#testNativeJoin"})
